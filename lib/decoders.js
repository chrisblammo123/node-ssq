...
// steam update 2020 that lets servers do S2C_CHALLENGE responses probably broke this for
// A2S_INFO, as it returns a 0x41 ('A') type, instead of the intended 0x49 ('I').
    if (values.type !== type) {
