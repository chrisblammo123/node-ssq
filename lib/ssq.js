...
var A2A_PING = Buffer.from("i") // note PING is deprecated
  , A2S_SERVERQUERY_GETCHALLENGE = Buffer.from([0xff, 0xff, 0xff, 0xff, 0x55])
  , A2S_INFO = Buffer.from([0xFF, 0xFF, 0xFF, 0xFF, 0x54, 0x53, 0x6F, 0x75, 0x72,
...
var NEG_1_BUFFER = Buffer.from([0xff, 0xff, 0xff, 0xff]);
